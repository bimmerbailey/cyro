...
class TestTheme:
    ...
    def test_theme_creation(self):
        ...
        colors = ColorScheme(
            primary="blue", secondary="cyan", accent="bright_cyan",
            success="green", warning="yellow", error="red", info="blue",
            text="white", text_dim="dim", background="default", border="blue",
            highlight="bold blue", code_bg="default", code_text="white",
            syntax_keyword="bold blue", syntax_string="green", syntax_comment="dim",
            table_header="bold blue", table_row="white", prompt="bold blue",
            input_default="cyan"
        )
...
class TestDefaultThemes:
    ...
    def test_all_themes_have_required_colors(self):
        ...
        required_colors = [
            ...
            "info", "text", "text_dim", "background", "border", "highlight",
            "code_bg", "code_text", "syntax_keyword", "syntax_string", 
            "syntax_comment", "table_header", "table_row", "prompt", "input_default"
        ]
        
        for theme_name, theme in DEFAULT_THEMES.items():
            for color_name in required_colors:
                assert hasattr(theme.colors, color_name), f"Theme '{theme_name}' missing color '{color_name}'"
                color_value = getattr(theme.colors, color_name)
                assert color_value is not None, f"Theme '{theme_name}' has None for color '{color_name}'"
                assert isinstance(color_value, str), f"Theme '{theme_name}' color '{color_name}' is not a string"
